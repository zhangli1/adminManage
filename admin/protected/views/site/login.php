...
<!-- Favicons --> 
<link rel="shortcut icon" type="image/png" HREF="<?php echo Yii::app()->baseUrl; ?>/imaages/favicons/favicon.png"/>
	...
	<div id="page">
		...
		<div class="wrapper-login">
				...
				<section class="full">					
					...
					<form id="loginform" method="post" action="<?php echo Yii::app()->createUrl('site/login') ?>">
